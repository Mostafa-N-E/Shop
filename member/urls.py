...
urlpatterns = [
    ...
    path('profile/<int:pk>', views.ProfileView.as_view(), name='customer_profile'),
    path('profile/edit-info/<int:pk>', views.Profile_edit.as_view(), name='customer_profile_edit'),
